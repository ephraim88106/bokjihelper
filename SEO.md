...
```
O  https://bokjihelper.pages.dev/article-name
X  https://bokjihelper.pages.dev/article-name.html
```
...
- Google Search Console — 사이트맵 제출: `https://bokjihelper.pages.dev/sitemap.xml`
